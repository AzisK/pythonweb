...
var Router = function () {
  ...
  _createClass(Router, [{
    ...
    key: 'show',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(pageName) {
        var page;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                page = this.routes[pageName];
                _context2.next = 3;
                return page.load();
